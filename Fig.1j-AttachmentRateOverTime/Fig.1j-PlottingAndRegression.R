...
est
#We can also calucate the upper and lower 95% confidence intervals using the Std.Error value
...
#FYI the visualisation for the model with Days as a predictor variable (which isn't statistically significant) is below, just so you have the
